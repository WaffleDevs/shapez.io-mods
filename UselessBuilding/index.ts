...
class MetaModFlipperBuilding extends ModMetaBuilding {
    ...
    getAdditionalStatistics(root) {
        ...
        return [[T.ingame.buildingPlacement.infoTexts.speed, formatItemsPerSecond(speed)]] as [string, string][];
    }
    ...
    override init() {
        ...
        this.signals.stateEntered.add((state) => {
            if (state.key === "MainMenuState") {
                ...
                button.innerText = this.settings.enabled ? "On: Disable" : "Off: Enable";
